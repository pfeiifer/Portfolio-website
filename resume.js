...
const PHRASES = [
    "Education:\nB.S Computer Science - Pwani University, 2028.\n",
    "Technical Skills:\nI use languages like Java, Python, C, C++ for development.\nI'm proficient in working with Git and Github, Powershell and Linux.\n",
    "Professional experience:\nSoftware Developer\n",
    "Summary Profile:\nA Computer Science major with 1+ experience specializing in C, Java, C++ and Python with the ability to optimize API performance, build and deploy robust and scalable systems."
];
